...
class Auth extends ShieldAuth
{
    ...
    public array $tables = [
        'users'             => 'usuario',
        'identities'        => 'identidad_autenticacion',
        'logins'            => 'intento_login',
        'token_logins'      => 'token_login',
        'remember_tokens'   => 'recordar_token',
        'groups_users'      => 'grupo_usuario',
        'permissions_users' => 'permiso_usuario',
    ];
     ...
     */
    public string $userProvider = UsuarioModel::class;
